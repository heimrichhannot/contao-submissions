 ...
 * Fields
 */
$arrLang['userAuthor'] = array('Autor (Benutzer)', 'Wählen Sie hier den Autoren der Einsendung aus.');
$arrLang['memberAuthor'] = array('Autor (Mitglied)', 'Wählen Sie hier den Autoren der Einsendung aus.');
